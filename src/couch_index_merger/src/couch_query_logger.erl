...
-export([start_link/0, log/3, change_interval/1, reset_interval/0]).
...
handle_call({Path, Origin, Staleness}, _From, State) ->
...
terminate(Reason, _State) ->
    ...
    ?LOG_ERROR("couch_query_logger terminating because of ~p : ~p", [Msg, Len]),
    ok.
